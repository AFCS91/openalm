        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Área de Trabalho <small>Análise</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Projetos
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
               	...
               	<div ng-controller="redmineController">
...
<script type="text/javascript">
  ...
  <script src="recursos/js/plugins/morris/morris-data.js"></script> <!--  arquivo que eu irei passar os valores para o grafico -->
