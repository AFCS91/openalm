                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Visão Geral <small>Análise</small>
                        </h1>
                        <!--
                        <ol class="breadcrumb">
                            <li class="active">
                 ...
                 <div class="row">   
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Projetos</h3>
                            </div>
                            <div class="panel-body">
                                <div ng-controller="redmineController" class="table-responsive">
